...
```
Start-Llama3Cli [-ModelPath] <String> [[-ChatTemplate] <String>] [[-SysMessage] <String>]
 [[-PromptCache] <String>] [[-LogFile] <String>] [[-TensorSplit] <String>] [[-GpuLayers] <Int32>]
 [[-ContextSize] <Int32>] [[-Threads] <Int32>] [[-ThreadsBatch] <Int32>] [[-Temperature] <Single>]
