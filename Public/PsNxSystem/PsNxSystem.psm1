...
# Generated at: 05/09/2025 02:30:27
...
.PARAMETER Reload
Reload the configuration of the specified unit
...
.PARAMETER Mask
Mask the specified unit to prevent it from being started


.PARAMETER Unmask
Unmask the specified unit to allow it to be started


.PARAMETER DaemonReload
Reload systemd manager configuration


.PARAMETER IsActive
Check if the specified unit is active


.PARAMETER IsEnabled
Check if the specified unit is enabled
